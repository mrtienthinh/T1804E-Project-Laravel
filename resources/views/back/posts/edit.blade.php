                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="slug" type="text" class="form-control" value="{{ $posts->slug }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" id="body" rows="10" class="form-control"> {{ $posts->body }} </textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input name="published_at" type="text" class="form-control" value="{{ $posts->published_at }}">
                            </div>
                        </div>
