                    ...
                    <div class="padding-10">
                        ...
                        <div class="post-meta no-border">
                            <ul class="post-meta-group">
                                <li><i class="fa fa-user"></i><a href="{{$post->user_id == null ? "Author" : action('Front\HomeController@show',$post->user->slug)}}" style="color: #72afd2;"> {{$post->user_id == null ? "Author" : $post->user->name}}</a></li>
            ...
            <article class="post-author padding-10">
                <div class="media">
                    <div class="media-left">
                        <a href="#">
                            <img alt="Author 1" src="{{asset('img/user'.$randomImage.'-128x128.jpg')}}" class="media-object">
                        </a>
                    </div>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="{{$post->user_id == null ? "Author" : action('Front\HomeController@show', $post->user->slug)}}">{{$post->user_id == null ? "Author" : $post->user->name}}</a></h4>
                        <div class="post-author-count">
                            <a href="#">
                                <i class="fa fa-clone"></i>
                                {{$post->user_id == null ? "None" :  $post->user->posts->count()}} posts
                            </a>
                        </div>
                        <p>{{$post->user_id == null ? "None" : $post->user->bio}}</p>
                    </div>
                </div>
            </article>
